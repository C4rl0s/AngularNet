...
using WebApplicationAngularCsharp.Models;
using WebApplicationAngularCsharp.Utility;

namespace WebApplicationAngularCsharp.Controllers
{
    ...
    public class ClubsController : ApiController
    {
        ...
        public IHttpActionResult Get(int pageSize, int pageNumber, string orderBy = "")
        {
            ...
            if (QueryHelper.PropertyExists<ClubsModels.Club>(orderBy))
            {
                var orderByExpression = QueryHelper.GetPropertyExpression<ClubsModels.Club>(orderBy);
